            ...
            </div>
            {
                ...
                <nav>
                    <div className="px-2 py-3 border-b border-gray-800">
                        <a href="#"
                           className="block px-3 py-2 rounded hover:bg-gray-600 leading-tight font-semibold text-white">List
                            your property</a>
                        <a href="#"
                           className="block px-3 py-2 rounded hover:bg-gray-600 leading-tight mt-1 font-semibold text-white">Trips</a>
                        <a href="#"
                           className="block px-3 py-2 rounded hover:bg-gray-600 leading-tight mt-1 font-semibold text-white">Messages</a>
                    </div>
                    <div className="px-5 py-3">
                        <div className="flex items-center">
                            ...
                            <span className="ml-4 font-semibold text-gray-200">Mary Anna</span>
                        </div>
                        <div className="mt-5">
